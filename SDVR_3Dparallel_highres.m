...
for a=1:1
    tic
        ...
        lz=7.6e-9;%str2double(uinput(3))*10^-9;     %convert string from user into a number

        nx=[.3 .6 .5 .4 .3 .2 .1 .09 .08 .07 .06 .05 .04 .03 .02 .01].*10^(-9); %str2double(uinput(4))*10^-9;     %convert string from user into a number

        ny=[.3 .6 .5 .4 .3 .2 .1 .09 .08 .07 .06 .05 .04 .03 .02 .01].*10^(-9); %str2double(uinput(5))*10^-9;     %convert string from user into a number        

        nz=[.8 .6 .5 .4 .3 .2 .1 .09 .08 .07 .06 .05 .04 .03 .02 .01].*10^(-9); %str2double(uinput(6))*10^-9;     %convert string from user into a number
        
        shape=1; %str2double(uinput(7));        %convert string from user into a number
